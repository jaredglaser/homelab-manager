...
bun run test                  # Same as above + coverage enforcement (94%/98%)
...
bun run test:coverage:agent   # Agent tests + coverage enforcement (94%/98%)
