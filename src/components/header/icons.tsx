...
export function DockerIcon({ size = 18 }: Readonly<IconProps>) {
  return (
    <svg viewBox="-23 -23 558 558" width={size} height={size} fill="currentColor" aria-hidden="true" focusable="false">
...
export function ProxmoxIcon({ size = 18 }: Readonly<IconProps>) {
  return (
    <svg viewBox="-22 -22 557 557" width={size} height={size} fill="currentColor" aria-hidden="true" focusable="false">
