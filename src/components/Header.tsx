...
function DockerIcon({ size = 18 }: IconProps) {
  return (
    <svg viewBox="-1 70 514 372" width={size} height={size} fill="currentColor" className="mr-2">
...
function ProxmoxIcon({ size = 18 }: IconProps) {
  return (
    <svg viewBox="0 34 512 444" width={size} height={size} fill="currentColor" className="mr-2">
