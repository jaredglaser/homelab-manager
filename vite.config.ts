...
function buildAliases(): Record<string, string> {
  ...
  // monaco-worker-manager (used by monaco-yaml) imports a deep monaco-editor
  // subpath that the package's exports map (monaco-editor >= 0.55) refuses to
  // resolve. The file exists; alias straight to it.
  return {
